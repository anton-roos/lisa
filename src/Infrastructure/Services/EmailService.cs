    ...
    public async Task SendEmailAsync(string to, string subject, string body, Guid schoolId)
    {
        ...
        while (retryCount < DefaultRetryCount)
        {
            try
            {
                ...
                using var smtpClient = CreateSmtpClient(school ?? new());
                using var mailMessage = CreateMailMessage(to, subject, body, school ?? new());
                ...
                _logger.LogInformation(
                    ...
                    to,
                    subject,
                    school.Value.SmtpHost,
                    school.Value.SmtpPort);
